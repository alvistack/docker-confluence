...
ENV CONFLUENCE_DOWNLOAD_URL      "http://downloads.atlassian.com/software/confluence/downloads/atlassian-confluence-6.8.0.tar.gz"
...
RUN set -ex \
    && curl -skL https://downloads.mariadb.com/Connectors/java/connector-java-2.2.1/mariadb-java-client-2.2.1.jar > $CONFLUENCE_CATALINA/confluence/WEB-INF/lib/mariadb-java-client-2.2.1.jar
