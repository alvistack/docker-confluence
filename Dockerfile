...
ENV CONFLUENCE_DOWNLOAD_URL      "http://downloads.atlassian.com/software/confluence/downloads/atlassian-confluence-6.10.0.tar.gz"
...
RUN set -ex \
    ...
    && tar zxf $ARCHIVE --strip-components=1 -C $CONFLUENCE_CATALINA/confluence/WEB-INF/lib/ mysql-connector-java-5.1.46/mysql-connector-java-5.1.46-bin.jar \
    && rm -rf $ARCHIVE
