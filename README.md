...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/confluence-9.4.svg)](https://hub.docker.com/r/alvistack/confluence-9.4)
...
- [`alvistack/confluence-9.4`](https://hub.docker.com/r/alvistack/confluence-9.4)
  - [`packer/docker-9.4/packer.json`](https://github.com/alvistack/docker-confluence/blob/master/packer/docker-9.4/packer.json)
...
Start Atlassian Confluence Server:
    ...
    # Pull latest image
    docker pull alvistack/confluence-9.4
