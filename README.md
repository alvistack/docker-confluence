...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/confluence-8.6.svg)](https://hub.docker.com/r/alvistack/confluence-8.5)
...
-   [`alvistack/confluence-8.6`](https://hub.docker.com/r/alvistack/confluence-8.5)
    -   [`packer/docker-8.6/packer.json`](https://github.com/alvistack/docker-confluence/blob/master/packer/docker-8.5/packer.json)
...
Start Atlassian Confluence Server:
    ...
    # Pull latest image
    docker pull alvistack/confluence-8.6
